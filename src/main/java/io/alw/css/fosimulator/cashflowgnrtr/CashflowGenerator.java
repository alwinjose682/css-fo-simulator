...
public final class CashflowGenerator extends Stoppable implements Runnable {
    ...
    private final FoCashMessageConsumer cashMessageConsumer;
    private final GeneratorDetail generatorDetail;
    private final long pauseIntervalSeconds;
    private final RandomGenerator rndm;

    public CashflowGenerator(GeneratorDetail generatorDetail, Supplier<List<FoCashMessage>> cashMessageSupplier, FoCashMessageConsumer cashMessageConsumer) {
        super();
